...
// 當數字和字串相乘時，js 會將字串轉換成數字
// '8' 會被轉換成數字 8
// 所以 k * l 是 3 * 8 = 24
// 最後比較 24 > 21，所以結果為true
...
if (giftPriceRule >= 1599 || BobIsVip === true) {
  giftNum -= 1;
...
calorieBurn = activities.bike * 20 + activities.treadmill * 10 + activities.yoga * 40
...
for(i=1; i > exerciseRecords.length; i++) {
